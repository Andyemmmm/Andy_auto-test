...
# @Author   : Andy
# @time     : 2020/1/8 11:07
# @File     : page_updatearticle_case_analysis.py
# @Software : aiwen_ui
...
class Page_UpdateArticle_Case_analysis(SeleniumBase):
    '''这个是病例分析--写文章的页面'''

    loc_撰写病例 = (By.XPATH, '//*[@id="btn_new"]')
    loc_选择病例 = (By.XPATH, '//*[@id="btn_old"]')
    loc_病例记录 = (By.XPATH, '//*[@id="page_content"]/ul/li/div[2]/a')
    lco_frame0 = ('ueditor_0')
    loc_frame1 = ('ueditor_1')
    loc_frame2 = ('ueditor_2')
    loc_输入框 = (By.XPATH, '/html/body')
    loc_下一步 = (By.XPATH, '/html/body/div[3]/div/div[3]/div[2]/div[1]/a[1]')

    def click_撰写病例(self):
        self.click_element(self.loc_撰写病例)
        return self

    def click_病例记录(self):
        self.click_element(self.loc_病例记录)
        return self

    def click_选择病例(self):
        self.click_element(self.loc_选择病例)
        return self
    ...
    def send_医生心得(self, content):
        self.send_keys(self.loc_输入框, content)
        return self

    def switch_frame0(self):
        self.switch_to_frame(self.lco_frame0)
        return self

    def switch_frame1(self):
        self.switch_to_frame(self.loc_frame1)
        return self

    def switch_frame2(self):
        self.switch_to_frame(self.loc_frame2)
        return self
...
class Page_UpdateArticle_nextstep_case_analysis(SeleniumBase):
    '''这个是病例分析--写文章下一步的页面'''
    loc_文章标题 = (By.XPATH, '//*[@id="title"]')
    loc_文章类别 = (By.XPATH, '//*[@id="dept"]')
    loc_文章标签 = (By.XPATH, '/html/body/div[3]/div/div[3]/dl/dd[3]/div[2]')
    loc_文章标签_选项1 = (By.XPATH, '/html/body/div[3]/div/div[3]/dl/dd[3]/div[3]/div[2]/div/a[1]')
    loc_文章标签_选项2 = (By.XPATH, '/html/body/div[3]/div/div[3]/dl/dd[3]/div[3]/div[2]/div/a[2]')
    loc_空白 = (By.XPATH, '/html/body/div[3]/div/div[3]/dl/dd[3]/div[3]')
    lco_上传图片 = (By.XPATH, '//*[@id="ttupimg"]')
    ...
    def offset_裁切(self, driver):
        self.by_offset(self.loc_裁切框, driver)
        return self
...
class Page_UpdateArticle_timestep_case_analysis(SeleniumBase):
    '''这个是病例分析---写文章发布时间设置的页面'''
...
class Page_UpdateArticle_ditchstep_case_analysis(SeleniumBase):
    '''这个是病例分析---写文章设置渠道授权的页面'''

    loc_发布 = (By.XPATH, '//*[@id="next"]')
    loc_同步到微博 = (By.XPATH, '/html/body/div[3]/div/div[3]/div[3]/div[2]/input')
...
class Page_UpdateArticle_success_case_analysis(SeleniumBase):
    '''这个是诊间日记---写文章发布成功的页面'''
