...
# @Author   : Andy
# @time     : 2020/1/8 11:02
# @File     : page_updatearticle_Clinic_and_diary.py
# @Software : aiwen_ui
...
class Page_UpdateArticle_Clinic_and_diary(SeleniumBase):
    '''这个是诊间日记--写文章的页面'''

    loc_输入框 = (By.XPATH, '//*[@id="pspContent-text"]')
...
class Page_UpdateArticle_nextstep_Clinic_and_diary(SeleniumBase):
    '''这个是诊间日记--写文章下一步的页面'''

    loc_文章类别 = (By.XPATH, '//*[@id="deptName"]')
    loc_文章标签 = (By.XPATH, '/html/body/div[3]/div/div[3]/dl/dd[2]/div[2]')
    loc_文章标签_选项1 = (By.XPATH, '/html/body/div[3]/div/div[3]/dl/dd[2]/div[3]/div[2]/div/a[1]')
    loc_文章标签_选项2 = (By.XPATH, '/html/body/div[3]/div/div[3]/dl/dd[2]/div[3]/div[2]/div/a[2]')
    loc_空白 = (By.XPATH, '/html/body/div[3]/div/div[3]/dl/dd[2]/div[3]')
    lco_上传图片 = (By.XPATH, '//*[@id="xxupimg"]')
    loc_裁切框 = (By.XPATH, '//*[@id="preview"]/div/div[1]/div[1]/div[5]')
    loc_裁切确定 = (By.XPATH, '/html/body/div[14]/div[3]/a[1]')
    loc_下一步 = (By.ID, 'next')
...
class Page_UpdateArticle_timestep_Clinic_and_diary(SeleniumBase):
    '''这个是诊间日记---写文章发布时间设置的页面'''

    loc_日期框 = (By.XPATH, '//*[@id="date"]')
    loc_下一步 = (By.ID, 'next')
    loc_今日 = (By.XPATH, '/html/body/div[10]/div[3]/table/tfoot/tr/th')
...
class Page_UpdateArticle_ditchstep_Clinic_and_diary(SeleniumBase):
    '''这个是诊间日记---写文章设置渠道授权的页面'''
...
class Page_UpdateArticle_success_Clinic_and_diary(SeleniumBase):
    '''这个是诊间日记---写文章发布成功的页面'''
